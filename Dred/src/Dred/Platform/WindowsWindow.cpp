#include "pre.h"
#include "Dred/Log.h"
#include "Dred/Platform/WindowsWindow.h"
...
namespace Dred{
	...
	void WindowsWindow::Init(const WindowProps& props) {
		...
		DD_CORE_INFO("Creating Window {0} of ({1}, {2})", props.Title, props.Width, props.Height);

		if (!s_GLFWintialized) {
			int success;
			success = glfwInit();
			DD_CORE_ASSERT(success, "Window not Initalized"); 
		...
		DD_ASSERT(status, "GLAD Failed to initialize")
